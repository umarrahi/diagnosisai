...
<head>
    ...
    <!-- Title -->
    <title>Lifestyle & Energy (Page 5)</title>
    <!-- Favicon -->
                            ...
                            <form action="#">
                                <div class="row gy-20">
                                    ...
                                    <div class="flex-align justify-content-end gap-8">
                                        <a href="diagnosis-p-4.html" class="btn btn-outline-main rounded-pill py-9">Back</a>
                                        <a href="diagnosis-p-6.html" class="btn btn-main rounded-pill py-9">Next</a>
                                    </div>
                                </div>
                            </form>
                        </div>
