...
<head>
    ...
    <!-- Title -->
    <title>Medical History (Page 7)</title>
    <!-- Favicon -->
                        ...
                        <div class="card-body p-40">
                            <form action="#">
                                ...
                                <div class="flex-align justify-content-end gap-8">
                                    <a href="diagnosis-p-6.html" class="btn btn-outline-main rounded-pill py-9">Back</a>
                                    <a href="diagnosis-final-result.html" class="btn btn-main rounded-pill py-9">Next</a>
                                </div>
                        </div>
                        </form>
                    </div>
