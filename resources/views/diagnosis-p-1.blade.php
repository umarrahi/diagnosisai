...
<head>
    ...
    <!-- Title -->
    <title>Personal Information (Page 1)</title>
    <!-- Favicon -->
                            ...
                            <form action="#">
                                <div class="row gy-20">
                                    ...
                                    <div class="col-sm-12 gap-2 0 d-flex align-items-center flex-wrap">
                                        ...
                                        <span class="fs-1 text-gray-400">I am (Male/Female)</span>
                                        <div class="">
                                            <select id="" class="form-select fs-2 border-0 border-bottom fst-italic fw-bold">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control fs-2 border-0 border-bottom text-gray-400 fst-italic fw-bold">
                                        </div>
                                        ...
                                        <div class="">
                                            <input type="tel" class="form-control fs-2 border-0 border-bottom text-gray-400 fst-italic fw-bold">
                                        </div>
                                        <span class="fs-1 text-gray-400">or email address</span>
                                        <div class="">
                                            <input type="email" class="form-control fs-2 border-0 border-bottom text-gray-400 fst-italic fw-bold">
                                        </div> 
                                        <span class="fs-1 text-gray-400">.</span> 
                                    </div>
                                    <div class="flex-align justify-content-end gap-8">
                                        <a href="index.html" class="btn btn-outline-main rounded-pill py-9">Back</a>
                                        <a href="diagnosis-p-2.html" class="btn btn-main rounded-pill py-9">Next</a>
                                    </div>
                                </div>
                            </form>
                        </div>
