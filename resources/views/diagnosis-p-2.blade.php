...
<head>
    ...
    <!-- Title -->
    <title>Demographic & Physical Details (Page 2)</title>
    <!-- Favicon -->
                            ...
                            <form action="#">   
                                <div class="row gy-20">
                                    ...
                                    <div class="flex-align justify-content-end gap-8">
                                        <a href="diagnosis-p-1.html"
                                            class="btn btn-outline-main rounded-pill py-9">Back</a>
                                        <a href="diagnosis-p-3.html" class="btn btn-main rounded-pill py-9">Next</a>
                                    </div>
                                </div>  
                            </form>
                        </div>
